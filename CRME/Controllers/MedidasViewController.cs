...
{
    public class MedidasViewController : Controller
    {
        // GET: MedidasView
        ...
        public ActionResult SaveCondicion(Medida condicion)
        {
            ...
            {
                if (condicion.Id_medida == 0)
                {
                    try
                    {
                        Medida condi = new Medida();
                ...
                else
                {
                    try
                    {
                        Medida Condi = db.Medida.Find(condicion.Id_medida);
                        Condi.Descripcion = condicion.Descripcion;
        ...
        {  //codigo para agregar y editar usuarios
            ...
            Medida condicion = new Medida();
            // Personas Persona = new Personas();

            if (Id_Condicion != null)
            {
                ViewBag.edit = 1;
                condicion = db.Medida.Find(Id_Condicion);
            }
        ...
        public ActionResult DeleteUsuario(long? Em_Cve_Empresa)
        {
            ...
            try
            {
                Medida condi = db.Medida.Find(Em_Cve_Empresa);
